...
(2, 'site_title', 'QuickVCard Digital Business Card'),
(3, 'meta_keywords', ''),
(4, 'meta_description', ''),
...
(29, 'copyright_text', '2020 Zeroappz, All right reserved'),
...
(131, 'site_url1', 'http://localhost/quickvcard/'),
(132, 'quickad_secret_file', '8c83wprwp7'),
...
(166, 'quickad_user_secret_file', 'ezwylz0f2k'),
(167, 'free_membership_plan', '{\"id\":\"free\",\"name\":\"Free Plan\",\"badge\":\"\",\"settings\":{\"field_limit\":2,\"scan_limit\":50,\"hide_branding\":0,\"custom\":[]},\"status\":1}'),
...
TRUNCATE TABLE `<<prefix>>vcards`;

TRUNCATE TABLE `<<prefix>>vcard_options`;

TRUNCATE TABLE `<<prefix>>vcard_view`;

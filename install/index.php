...
if(isset($config['installed']))
{
    if($config['version'] == $installing_version){
        exit('QuickVCard is already installed.');
...
<head>
    ...
    <title>QuickVCard Installation</title>
    ...
    <table width="500"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td><table width="500%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><span class="style1">QuickVCard Installation : Error</span></td>
        ...
        <tr>
            <td><div align="center"><span class="style5">&copy; 2008 <a href="https://zeroappz.com" target="_blank">Zeroappz.com</a></span> Version <?php echo $installing_version ?></div></td>
        </tr>
    </table>
...
elseif($step == 1)
{
    ...
    <div class="container">
        <table border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">QuickVCard Installation - Step: 1-3</span></td>
                            <td align="right" valign="bottom">&nbsp;</td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>Please select the language you would like QuickVCard to use:<br><small style="color:#FF0000;">*Some parts of the installation may not be in your chosen language</small><Br><br>
            ...
            <tr>
                <td><div align="center"><span class="style5">&copy; <?php echo date("Y"); ?> <a href="https://zeroappz.com" target="_blank">Zeroappz.com</a></span></div></td>
            </tr>
        </table>
    </div>
        ...
        <table  border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">QuickVCard Installation - Step: 2-4</span></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <form name="form1" method="post" action="index.php" style="padding:0px;margin:0px;">
                        <table border="0" cellspacing="10" cellpadding="3" align="center">
                            <tr>
                                <td align="center">Enter QuickVCard envato purchase code.</td>
                            <tr/>
                            <tr>
                                <td align="center">
                                    <?php
                        ...
                        <table border="0" cellspacing="0" cellpadding="3" align="center">
                            <tr>
                                ...
                                <td><span class="style12">&nbsp;<a href="javascript:alert('QuickVCard Purchase code');">(?)</a> </span></td>
                            </tr>
        ...
        <table  border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">QuickVCard Installation Step: 2-3</span></td>
                        </tr>
                    </table>
                </td>
            </tr>
                    ...
                    <form name="form1" method="post" action="index.php" style="padding:0px;margin:0px;">
                        ...
                        <table border="0" cellspacing="0" cellpadding="3" align="center">
                            ...
                            <tr>
                                ...
                                <td><input name="DBPre" type="text" id="DBPre" value="<?php if(isset($_POST['DBPre'])){ echo $_POST['DBPre']; } else { echo 'vc_'; } ?>"></td>
            ...
            <tr>
                <td><div align="center"><span class="style5">&copy; <?php echo date("Y"); ?> <a href="https://zeroappz.com" target="_blank">Zeroappz.com</a> Version <?php echo $installing_version ?></span></div></td>
            </tr>
        </table>
    </div>
        ...
        <table border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">QuickVCard Installation Step: 3-3</span></td>
                            <td align="right" valign="bottom">&nbsp;</td>
                        </tr>
                    </table>
                </td>
        ...
        <table border="0" align="center" cellpadding="10" cellspacing="3" align="center">
            <tr>
                <td>
                    <table border="0" cellspacing="10" cellpadding="3" align="center">
                        <tr>
                            <td><span class="style1">QuickVCard Installation</span></td>
                            <td align="right" valign="bottom">&nbsp;</td>
                        </tr>
                    </table>
                </td>
            ...
            <tr><td>Thank you for installing QuickVCard, please use the links below:</td></tr>
            ...
            <tr>
                <td><div align="center"><span class="style5">&copy; <?php echo date("Y"); ?> <a href="https://zeroappz.com" target="_blank">Zeroappz.com</a> Version <?php echo $installing_version ?></span></div>
                    <br>
                    <a href="https://bylancer.ticksy.com/" target="_blank">Support</a>
                </td>
            </tr>
        </table>
    </div>

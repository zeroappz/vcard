...
foreach ($queryRecords as $row) {
    ...
    $membership = get_user_membership_detail($row['id']);
    ...
    $row3 = '<td class="hidden-xs hidden-sm">'.$membership_name.'</td>';
    $row4 = '<td class="hidden-xs hidden-sm">'.$status.'</td>';
    $row5 = '<td class="hidden-xs hidden-sm">'.$joined.'</td>';
    $row6 = '<td class="text-center">
                <div class="btn-group">
                    <a href="#" class="btn btn-xs btn-default login-as-user" data-user-id="'.$id.'">Login</a>

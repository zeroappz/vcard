...
foreach ($queryRecords as $row) {
    ...
    $row1 = '<td>'.$log_summary.'</td>';
    $row2 = '<td>'.$log_date.'</td>';
    $row3 = '<td>'.$log_details.'</td>';
    $row4 = '<td class="text-center">
                <div class="btn-group">
                     <a href="javascript:void(0)" class="btn btn-xs btn-danger item-js-delete" data-ajax-action="deleteCronLog"> <i class="ion-close"></i></a>
                </div>
            </td>';

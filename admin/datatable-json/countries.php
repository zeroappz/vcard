...
foreach ($queryRecords as $row) {
    ...
    if ($status == "1"){
        ...
        $install_button = '<a href="javascript:void(0)" data-toggle="tooltip" data-original-title="Uninstall" class="btn btn-xs btn-warning uninstall-country" data-ajax-action="uninstallCountry"> <i class="fa fa-close"></i> Uninstall</a>';
    }
    elseif($status == "0")
    {
        $status = '<span class="label label-warning">Not Active</span>';
        $install_button = '<a href="javascript:void(0)" data-toggle="tooltip" data-original-title="Install" class="btn btn-xs btn-success  install-country"  data-ajax-action="installCountry"> <i class="fa fa-download"></i> Install</a>';
    }

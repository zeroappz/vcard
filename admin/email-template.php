                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_signup_details" rows="10" class="form-control" placeholder="Enter Message"><?php echo htmlspecialchars( get_option("email_message_signup_details"), ENT_QUOTES) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_signup_confirm" rows="10" class="form-control" placeholder="Enter Message"><?php echo htmlspecialchars( get_option("email_message_signup_confirm"), ENT_QUOTES) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_forgot_pass" rows="10" class="form-control" placeholder="Enter Message"><?php echo htmlspecialchars( get_option("email_message_forgot_pass"), ENT_QUOTES) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_contact" rows="10" class="form-control" placeholder="Enter Message"><?php echo htmlspecialchars( get_option("email_message_contact"), ENT_QUOTES) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_feedback" rows="10" class="form-control" placeholder="Enter Message"><?php echo htmlspecialchars( get_option("email_message_feedback"), ENT_QUOTES) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="row mailMethods mailMethod-1" <?php if($config['email_template'] != '1'){ echo 'style="display: none;"'; } ?>>
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <label for="pageContent">Message</label>
                                                                                        <textarea name="email_message_textarea_report" rows="10" class="form-control" placeholder="Enter Message"><?php echo htmlspecialchars( get_option("email_message_report"), ENT_QUOTES) ?></textarea>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="row">
                    ...
                    <div id="quickad-tbs">
                        <div class="btn-group quickad-margin-bottom-lg quickad-services-holder">
                            ...
                            <ul class="dropdown-menu" style="width: 570px">
                                ...
                                <li class="quickad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success" href="#">
                                        <input type="checkbox" class="quickad-js-check-entity" value="any" id="new-order" name="new-order">
                                        <label for="new-order">New order email </label>
                                    </a>
                                </li>
                                <li class="quickad-padding-horizontal-md">
                                    <a class="checkbox checkbox-success" href="#">

                ...
                <div class="white-box">
                    ...
                    <form name="form2"  class="form" method="post" data-ajax-action="editMembershipPlan" id="sidePanel_form">
                        <div class="form-body">
                            ...
                            <div class="row form-group">
                                <label class="col-sm-4 control-label">Additional Field Limit</label>
                                <div class="col-sm-8">
                                    <input name="field_limit" type="number" class="form-control" id="field_limit" value="<?php echo stripslashes($settings['field_limit']);?>">
                                    <p class="help-block">For unlimited, enter 999</p>
                                </div>
                            </div>
                            <div class="row form-group">
                                <label class="col-sm-4 control-label">Hide Branding</label>
                                <div class="col-sm-8">
                                    <label class="css-input switch switch-sm switch-success">
                                        <input name="hide_branding" type="checkbox" value="1" <?php if($settings['hide_branding'] == '1') echo "checked"; ?>/><span></span>
                                    </label>
                                </div>
                            </div>
                            <?php

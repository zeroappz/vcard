...
<head>
    ...
    <meta name="author" content="Zeroappz" />
            ...
            <div class="app-layout-drawer-scroll">
                ...
                <nav class="drawer-main">
                    <ul class="nav nav-drawer">
                        ...
                        <li class="nav-item">
                            <a href="vcards.php"><i class="fa fa-clone"></i> VCards</a>
                        </li>
                ...
                <div class="drawer-footer">
                    <p class="copyright"><a href="https://zeroappz.com" target="_blank">VCard By Zeroappz</a> &copy;</p>

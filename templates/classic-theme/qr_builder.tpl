                ...
                <div class="col-md-4 sticky-sidebar">
                    <div class="dashboard-box">
                        ...
                        <div class="content with-padding">
                            ...
                            <button class="button ripple-effect qr-code-downloader"><i class="icon-feather-download"></i> {LANG_DOWNLOAD_IMAGE}</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="dashboard-box">
                        <div class="headline">
                            <h3><i class="icon-feather-link"></i> {LANG_HELPFUL_LINKS}</h3>
                        </div>
                        <div class="content with-padding">
                            <p><a href="{LINK_ADD_VCARD}"><i class="icon-feather-edit"></i> {LANG_EDIT_VCARD}</a></p>
                            <p><a href="#" class="qr-code-downloader"><i class="icon-feather-download"></i> {LANG_DOWNLOAD_QRCODE}</a></p>
                            <p><a href="{CARD_URL}" class="live-preview-button"><i class="icon-feather-eye"></i> {LANG_LIVE_PREVIEW}</a></p>
                            <p><a href="#" class="copy-link" data-link="{CARD_URL}"><i class="icon-feather-copy"></i> {LANG_COPY_LINK}</a></p>
                        </div>
                    </div>
                </div>
            </div>
